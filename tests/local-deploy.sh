...
DEPLOY_ARGS="server_ip=127.0.0.1 server_user=root IP_subject_alt_name=127.0.0.1 local_dns=true dns_over_https=true apparmor_enabled=false ansible_port=2222"
